        ...
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.35fr)_repeat(3,minmax(0,0.8fr))]">
            <div className="max-w-md">
              <Link href="/" className="inline-flex items-center gap-3  py-2  transition hover:border-primary/20">
                <Image
                  src="/logo.png"
                  alt="ECKINTOSH logo"
                  width={56}
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {['Cloud', 'Security', 'Analytics', 'DevOps'].map((item) => (
                  <span
                    key={item}
                    className=" border-b border-border bg-white/85 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-slate-600"
                  >
                    {item}
                  </span>
                ))}
