...
import { Reveal, FadeIn, StaggerContainer, StaggerItem } from '@/components/motion-wrapper'
  ...
  return (
    <div id="top" className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <StaggerItem key={idx}>
                  <div className="group overflow-hidden rounded-xl border border-border bg-card p-8 transition hover:border-primary hover:shadow-lg h-full">
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-card">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <Reveal direction="right" className="bg-[url('/umat.jpeg')] bg-cover bg-center rounded-2xl h-96 flex items-center justify-center">    
            </Reveal>
            ...
            {recentProjects.map((project) => {
              ...
              return (
                <StaggerItem key={project.title}>
                  <article
                    className="group isolate h-full overflow-hidden rounded-sm border border-border/70 bg-white/88 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur transition hover:-translate-y-1 hover:shadow-[0_28px_80px_rgba(15,23,42,0.12)]"
                  >
                    <div className="grid">
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary to-primary">
        <Reveal direction="up" className="max-w-4xl mx-auto text-center">
          ...
          {isSubmitted ? (
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-white animate-in fade-in zoom-in duration-300">
              <h3 className="text-2xl font-bold mb-2">Message Sent!</h3>
              <p className="text-blue-100">Thank you for your interest. Our team will contact you within 2 business hours.</p>
            </div>
          ) : (
            <form onSubmit={handleEmailSubmit} className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              />
              <button type="submit" className="bg-white text-primary px-8 py-4 rounded-lg hover:bg-blue-50 transition font-semibold text-lg">
                Schedule Call
              </button>
            </form>
          )}
